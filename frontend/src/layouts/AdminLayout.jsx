    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-6 border-b border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-lg font-bold text-white">DriveEase</span>
      ...
      <div className="p-4 border-t border-gray-800">
        <Link to="/" className="flex items-center gap-2 px-4 py-2 text-sm text-gray-400 hover:text-white transition-colors mb-2" onClick={() => setSidebarOpen(false)}>
        ...
        <button onClick={handleLogout} className="flex items-center gap-2 w-full px-4 py-2.5 mt-2 text-sm text-red-400 hover:bg-red-500/10 rounded-lg transition-colors">
          <FaSignOutAlt /> Logout
        </button>
      </div>
    </div>
        ...
        {sidebarOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed top-0 left-0 bottom-0 w-64 bg-primary-900 z-40 lg:hidden"
            >
              <SidebarContent />
            </motion.aside>
          </>
          ...
          <div className="flex items-center justify-between px-4 sm:px-6 h-16">
            ...
            <div className="flex items-center gap-2">
              {location.pathname === '/admin/cars' && (
                <Link to="/admin/cars/add" className="btn-primary text-sm py-2 px-3 flex items-center gap-1.5">
